...
jQuery(document).ready(function ($) {
  ...
  //  STEP RIGHT
  var stepRMain = document.querySelector('.--right');
  var stepRFirst = document.querySelector('.steps-item__right-1');
  ...
  function animLR() {
    var animLr = new Vue({
      ...
      methods: {
        changeSide: function changeSide(event) {
            ...
            if (stepBool) {
              (function animateSvg() {
                ...
                basicTimeline.add({
                  ...
                  opacity: 1,
                  scale: [{ value: 1.1, elasticity: 100 }, { value: 1, elasticity: 100 }],
            ...
            if (stepBool2) {
              (function animateSvg2() {
                ...
                basicTimeline3.add({
                  ...
                  easing: "easeInOutQuad",
                  delay: function delay(dtime, fb, _delay) {
                    return 1300 * (1 + fb);
                  },
                  offset: "-=600"
                }).add({
                  ...
                  easing: "easeInOutQuad",
                  delay: function delay(dtime, fb, _delay2) {
                    return 1100 * (1 + fb);
                  },
                  offset: "-=600"
                });
