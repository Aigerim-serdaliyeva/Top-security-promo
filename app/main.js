...
jQuery(document).ready(function ($) {
  ...
  if (window.matchMedia("(min-width: 960px)").matches) {
    ...
    var stepsVue = new Vue({
      ...
      data: {
        ...
        booleanT1: true,
        booleanT2: true,
        lists1: [{ id: 'left-svg1', class: 'content__img content__img__red', img: 'assets/media/images/content/steps-before-image1.jpg',
          text: '\u0417\u043B\u043E\u0443\u043C\u044B\u0448\u043B\u0435\u043D\u043D\u0438\u043A \n         \u043F\u0440\u043E\u043D\u0438\u043A\u0430\u0435\u0442 \u0432 \u043F\u043E\u043C\u0435\u0449\u0435\u043D\u0438\u0435 \n         1 \u043C\u0438\u043D' }, { id: 'left-svg2', class: 'content__img content__img__red', img: 'assets/media/images/content/steps-before-image2.jpg',
        ...
        lists2: [{ id: 'left-svg6', class: 'content__img content__img__red', img: 'assets/media/images/content/steps-before-image4.jpg',
        ...
        lists3: [{ id: 'right-svg1', class: 'content__img content__img__yellow', img: 'assets/media/images/content/steps-after-image1.jpg',
        ...
        lists4: [{ id: 'right-svg6', class: 'content__img content__img__yellow', img: 'assets/media/images/content/steps-after-image4.jpg',
          text: '\n        \u041A\u043B\u0438\u0435\u043D\u0442 \u043D\u0430\u0441\u043B\u0430\u0436\u0434\u0430\u0435\u0442\u0441\u044F \n    \u043F\u043E\u043A\u043E\u0435\u043C\n        '
      ...
      methods: {
        changeLeftWidth: function changeLeftWidth() {
          this.leftWidth = 2;this.rightWidth = 1;
          this.leftShow = false;this.rightShow = true;
          this.lhShow = true;this.rhShow = false;
          if (this.booleanT1) {
            var svgAnimTop = document.querySelector('.tp-step-left .svg-anim-top path'),
        ...
        changeRightWidth: function changeRightWidth() {
          this.leftWidth = 1;this.rightWidth = 2;
          this.leftShow = true;this.rightShow = false;
          this.rhShow = true;this.lhShow = false;

          if (this.booleanT2) {
            var svgAnimTop = document.querySelector('.tp-step-right .svg-anim-top path'),
  ...
  // inputs label logic
  function inputLabel() {
    $('.input-value').on('focus', function (event) {
      $(event.target).parent().find('label').addClass('focus');
    });
    $('.input-value').on('blur', function (event) {
      $(event.target).parent().find('label').removeClass('focus');
    });
    $('.input-value').on('input', function (event) {
  ...
  function spyCrawler() {
    ...
    $spyTo.each(function () {
      ...
      if (wTop >= blockTop) {
        ...
        $('.navbar-menu-item').last().find('.navbar-menu-link').addClass('active').parent().siblings().find('.spy').removeClass('active');
      }
    });
  }
  spyCrawler();
  ...
  $('.testimonials-carousel').on('init', function () {
  ...
  $('.testimonials-nav').click(function (event) {
    var $this = $(event.target);
    var index = $('.testimonials-nav').index($this);
    console.log(index);
  ...
  function openLicense() {
    ...
    document.querySelector('.license').addEventListener('click', function (e) {
      e = event.target;
      switch (e.id) {
        case 'license-first':
    ...
    document.querySelectorAll('.license-hidden > button').forEach(function (el) {
      el.addEventListener('click', function () {
  ...
  jivoClick.addEventListener('click', function () {
    jivoVisible();
    jivo_api.open();
    setTimeout(function () {
      document.querySelector('#jivo_close_button').addEventListener('click', function () {
        jivoInVisible();
      });
    }, 500);
  });
  ...
  if (window.matchMedia("(max-width:960px)").matches) {
    ...
    openLicense();
    document.querySelectorAll('.services__button').forEach(function (el) {
      el.addEventListener('click', function () {
...
var elemOffset = document.querySelector('#triggerElem').offsetTop,
...
document.querySelector('.close-butt').addEventListener('click', function () {
  modalSpec.classList.remove('modal-visible');
});
var prevented = document.querySelector('.prevent-new-mail');

prevented.addEventListener('click', function (event) {
